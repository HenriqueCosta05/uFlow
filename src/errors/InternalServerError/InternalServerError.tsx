...
import ServerError from '../../assets/errors/InternalServerError.svg?react'
import ErrorBoundaryStyles from './InternalServerError.module.css'

interface InternalServerErrorProps {
    onRetry?: () => void
    errorMessage: string
}
export const InternalServerErrorUI = (Props: InternalServerErrorProps) => {
    ...
    return (
        <BoxComponent className={ErrorBoundaryStyles.ErrorBoundary__Wrapper}>
            ...
            >
                ...
                >
                    {t('errors.500.title', 'Something went wrong')}
                </TypographyComponent>
                <TypographyComponent
                    variant="body1"
                ...
                >
                    ...
                    <ButtonComponent
                        ...
                        variant="secondary"
                    >
                        {t('errors.500.contactSupport', 'Contact Support')}
                    </ButtonComponent>
                </BoxComponent>
                <BoxComponent
                    className={
...
export default InternalServerErrorUI
